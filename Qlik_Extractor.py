...
## for extraction of particular Qlik Report
...
if __name__ == '__main__':
    ...
    app_input_arg = arguments[2].strip()
    try:
        print("Qlik Extraction Started")
        main(app_input_arg)
        print("Qlik Extraction Stopped")
    except:
        print("Qlik Extraction Trigger Failed")
